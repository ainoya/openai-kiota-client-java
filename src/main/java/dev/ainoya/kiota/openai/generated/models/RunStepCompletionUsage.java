...
public class RunStepCompletionUsage implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new RunStepCompletionUsage and sets the default values.
     */
    ...
    public static RunStepCompletionUsage createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new RunStepCompletionUsage();
    }
    /**
    ...
    /**
     * Gets the completion_tokens property value. Number of completion tokens used over the course of the run step.
     * @return a Integer
     */
    ...
    /**
     * Gets the prompt_tokens property value. Number of prompt tokens used over the course of the run step.
     * @return a Integer
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Sets the completion_tokens property value. Number of completion tokens used over the course of the run step.
    ...
    /**
     * Sets the prompt_tokens property value. Number of prompt tokens used over the course of the run step.
