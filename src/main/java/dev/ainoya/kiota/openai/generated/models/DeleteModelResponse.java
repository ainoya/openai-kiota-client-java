...
public class DeleteModelResponse implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static DeleteModelResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
