...
public class ListMessageFilesResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The data property
     */
    private java.util.List<MessageFileObject> data;
    /**
    ...
    public static ListMessageFilesResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<MessageFileObject>
     */
    @jakarta.annotation.Nullable
    public java.util.List<MessageFileObject> getData() {
        return this.data;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("data", (n) -> { this.setData(n.getCollectionOfObjectValues(MessageFileObject::createFromDiscriminatorValue)); });
     ...
     */
    public void setData(@jakarta.annotation.Nullable final java.util.List<MessageFileObject> value) {
        this.data = value;
    }
    /**
