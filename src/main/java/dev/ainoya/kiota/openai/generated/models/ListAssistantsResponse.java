...
public class ListAssistantsResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The data property
     */
    private java.util.List<AssistantObject> data;
    /**
    ...
    public static ListAssistantsResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<AssistantObject>
     */
    @jakarta.annotation.Nullable
    public java.util.List<AssistantObject> getData() {
        return this.data;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("data", (n) -> { this.setData(n.getCollectionOfObjectValues(AssistantObject::createFromDiscriminatorValue)); });
     ...
     */
    public void setData(@jakarta.annotation.Nullable final java.util.List<AssistantObject> value) {
        this.data = value;
    }
    /**
