...
public class DeleteAssistantFileResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The object property
     */
    private DeleteAssistantFileResponseObject object;
    /**
    ...
    public static DeleteAssistantFileResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("object", (n) -> { this.setObject(n.getEnumValue(DeleteAssistantFileResponseObject::forValue)); });
     ...
     * @return a DeleteAssistantFileResponseObject
     */
    @jakarta.annotation.Nullable
    public DeleteAssistantFileResponseObject getObject() {
        return this.object;
    }
    /**
     ...
     */
    public void setObject(@jakarta.annotation.Nullable final DeleteAssistantFileResponseObject value) {
        this.object = value;
    }
}
