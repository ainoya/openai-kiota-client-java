...
public class ChatCompletionMessageToolCallFunction implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String name;
    /**
     * Instantiates a new ChatCompletionMessageToolCallFunction and sets the default values.
     */
    ...
    public static ChatCompletionMessageToolCallFunction createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ChatCompletionMessageToolCallFunction();
    }
    /**
