...
public class ListRunStepsResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The data property
     */
    private java.util.List<RunStepObject> data;
    /**
    ...
    public static ListRunStepsResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<RunStepObject>
     */
    @jakarta.annotation.Nullable
    public java.util.List<RunStepObject> getData() {
        return this.data;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("data", (n) -> { this.setData(n.getCollectionOfObjectValues(RunStepObject::createFromDiscriminatorValue)); });
     ...
     */
    public void setData(@jakarta.annotation.Nullable final java.util.List<RunStepObject> value) {
        this.data = value;
    }
    /**
