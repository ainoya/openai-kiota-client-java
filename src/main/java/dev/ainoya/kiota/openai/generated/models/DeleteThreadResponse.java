...
public class DeleteThreadResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The object property
     */
    private DeleteThreadResponseObject object;
    /**
    ...
    public static DeleteThreadResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("object", (n) -> { this.setObject(n.getEnumValue(DeleteThreadResponseObject::forValue)); });
     ...
     * @return a DeleteThreadResponseObject
     */
    @jakarta.annotation.Nullable
    public DeleteThreadResponseObject getObject() {
        return this.object;
    }
    /**
     ...
     */
    public void setObject(@jakarta.annotation.Nullable final DeleteThreadResponseObject value) {
        this.object = value;
    }
}
