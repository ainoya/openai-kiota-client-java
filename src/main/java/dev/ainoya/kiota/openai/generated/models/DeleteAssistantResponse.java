...
public class DeleteAssistantResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The object property
     */
    private DeleteAssistantResponseObject object;
    /**
    ...
    public static DeleteAssistantResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("object", (n) -> { this.setObject(n.getEnumValue(DeleteAssistantResponseObject::forValue)); });
     ...
     * @return a DeleteAssistantResponseObject
     */
    @jakarta.annotation.Nullable
    public DeleteAssistantResponseObject getObject() {
        return this.object;
    }
    /**
     ...
     */
    public void setObject(@jakarta.annotation.Nullable final DeleteAssistantResponseObject value) {
        this.object = value;
    }
}
