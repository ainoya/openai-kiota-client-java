...
public class ChatCompletionTool implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private ChatCompletionToolType type;
    /**
     ...
     * @return a ChatCompletionTool
     */
    @jakarta.annotation.Nonnull
    public static ChatCompletionTool createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(ChatCompletionToolType::forValue)); });
     ...
     * @return a ChatCompletionToolType
     */
    @jakarta.annotation.Nullable
    public ChatCompletionToolType getType() {
        return this.type;
    }
    /**
     ...
     */
    public void setType(@jakarta.annotation.Nullable final ChatCompletionToolType value) {
        this.type = value;
    }
}
