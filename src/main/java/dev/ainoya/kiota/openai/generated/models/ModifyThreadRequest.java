...
public class ModifyThreadRequest implements Parsable {
    /**
     * Set of 16 key-value pairs that can be attached to an object. This can be useful for storing additional information about the object in a structured format. Keys can be a maximum of 64 characters long and values can be a maxium of 512 characters long.
     */
    private ModifyThreadRequestMetadata metadata;
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ModifyThreadRequest
     */
    @jakarta.annotation.Nonnull
    public static ModifyThreadRequest createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("metadata", (n) -> { this.setMetadata(n.getObjectValue(ModifyThreadRequestMetadata::createFromDiscriminatorValue)); });
     ...
     * @return a ModifyThreadRequestMetadata
     */
    @jakarta.annotation.Nullable
    public ModifyThreadRequestMetadata getMetadata() {
     ...
     */
    public void setMetadata(@jakarta.annotation.Nullable final ModifyThreadRequestMetadata value) {
        this.metadata = value;
    }
}
