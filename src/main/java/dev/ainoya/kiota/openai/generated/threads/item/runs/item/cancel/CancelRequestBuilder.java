package dev.ainoya.kiota.openai.generated.threads.item.runs.item.cancel;
...
/**
 * Builds and executes requests for operations under /threads/{thread_id}/runs/{run_id}/cancel
 */
...
public class CancelRequestBuilder extends BaseRequestBuilder {
    ...
    public CancelRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/threads/{thread_id}/runs/{run_id}/cancel", pathParameters);
    }
    /**
     * Instantiates a new CancelRequestBuilder and sets the default values.
    ...
    public CancelRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/threads/{thread_id}/runs/{run_id}/cancel", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public RunObject post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
