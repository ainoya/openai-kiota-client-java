...
public class ListRunsResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The data property
     */
    private java.util.List<RunObject> data;
    /**
    ...
    public static ListRunsResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<RunObject>
     */
    @jakarta.annotation.Nullable
    public java.util.List<RunObject> getData() {
        return this.data;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("data", (n) -> { this.setData(n.getCollectionOfObjectValues(RunObject::createFromDiscriminatorValue)); });
     ...
     */
    public void setData(@jakarta.annotation.Nullable final java.util.List<RunObject> value) {
        this.data = value;
    }
    /**
