...
public class ModifyAssistantRequest implements Parsable {
    /**
     ...
     */
    private ModifyAssistantRequestMetadata metadata;
    /**
     ...
     */
    private java.util.List<ModifyAssistantRequestTools> tools;
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ModifyAssistantRequest
     */
    @jakarta.annotation.Nonnull
    public static ModifyAssistantRequest createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("metadata", (n) -> { this.setMetadata(n.getObjectValue(ModifyAssistantRequestMetadata::createFromDiscriminatorValue)); });
        deserializerMap.put("model", (n) -> { this.setModel(n.getStringValue()); });
        deserializerMap.put("name", (n) -> { this.setName(n.getStringValue()); });
        deserializerMap.put("tools", (n) -> { this.setTools(n.getCollectionOfObjectValues(ModifyAssistantRequestTools::createFromDiscriminatorValue)); });
        return deserializerMap;
    }
    /**
     * Gets the file_ids property value. A list of [File](/docs/api-reference/files) IDs attached to this assistant. There can be a maximum of 20 files attached to the assistant. Files are ordered by their creation date in ascending order. If a file was previously attached to the list but does not show up in the list, it will be deleted from the assistant.
     ...
     * @return a ModifyAssistantRequestMetadata
     */
    @jakarta.annotation.Nullable
    public ModifyAssistantRequestMetadata getMetadata() {
     ...
     * @return a java.util.List<ModifyAssistantRequestTools>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ModifyAssistantRequestTools> getTools() {
        return this.tools;
    }
    /**
     ...
     */
    public void setMetadata(@jakarta.annotation.Nullable final ModifyAssistantRequestMetadata value) {
        this.metadata = value;
    }
    /**
     ...
     */
    public void setTools(@jakarta.annotation.Nullable final java.util.List<ModifyAssistantRequestTools> value) {
        this.tools = value;
    }
    /**
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class ModifyAssistantRequestTools implements ComposedTypeWrapper, Parsable {
        /**
         ...
         * Creates a new instance of the appropriate class based on discriminator value
         * @param parseNode The parse node to use to read the discriminator value and create the object
         * @return a ModifyAssistantRequestTools
         */
        @jakarta.annotation.Nonnull
        public static ModifyAssistantRequestTools createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final ModifyAssistantRequestTools result = new ModifyAssistantRequestTools();
