...
public class ListMessagesResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The data property
     */
    private java.util.List<MessageObject> data;
    /**
    ...
    public static ListMessagesResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<MessageObject>
     */
    @jakarta.annotation.Nullable
    public java.util.List<MessageObject> getData() {
        return this.data;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("data", (n) -> { this.setData(n.getCollectionOfObjectValues(MessageObject::createFromDiscriminatorValue)); });
     ...
     */
    public void setData(@jakarta.annotation.Nullable final java.util.List<MessageObject> value) {
        this.data = value;
    }
    /**
