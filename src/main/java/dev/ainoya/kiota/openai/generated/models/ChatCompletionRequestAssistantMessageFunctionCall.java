...
public class ChatCompletionRequestAssistantMessageFunctionCall implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String name;
    /**
     * Instantiates a new ChatCompletionRequestAssistantMessageFunctionCall and sets the default values.
     */
    ...
    public static ChatCompletionRequestAssistantMessageFunctionCall createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ChatCompletionRequestAssistantMessageFunctionCall();
    }
    /**
