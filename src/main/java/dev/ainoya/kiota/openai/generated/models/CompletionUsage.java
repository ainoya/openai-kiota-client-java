...
public class CompletionUsage implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static CompletionUsage createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    /**
     * Gets the completion_tokens property value. Number of tokens in the generated completion.
     * @return a Integer
     */
    ...
    /**
     * Gets the prompt_tokens property value. Number of tokens in the prompt.
     * @return a Integer
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Gets the total_tokens property value. Total number of tokens used in the request (prompt + completion).
     * @return a Integer
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Sets the completion_tokens property value. Number of tokens in the generated completion.
    ...
    /**
     * Sets the prompt_tokens property value. Number of tokens in the prompt.
    ...
    /**
     * Sets the total_tokens property value. Total number of tokens used in the request (prompt + completion).
