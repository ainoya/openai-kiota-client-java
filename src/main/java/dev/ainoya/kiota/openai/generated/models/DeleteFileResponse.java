...
public class DeleteFileResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The object property
     */
    private DeleteFileResponseObject object;
    /**
    ...
    public static DeleteFileResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("object", (n) -> { this.setObject(n.getEnumValue(DeleteFileResponseObject::forValue)); });
     ...
     * @return a DeleteFileResponseObject
     */
    @jakarta.annotation.Nullable
    public DeleteFileResponseObject getObject() {
        return this.object;
    }
    /**
     ...
     */
    public void setObject(@jakarta.annotation.Nullable final DeleteFileResponseObject value) {
        this.object = value;
    }
}
